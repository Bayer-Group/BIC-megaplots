...
mod_data_specification_server <- function(input, output, session) {
  ns <- session$ns
  output$data_specification <- shiny::renderUI({
    list(
      HTML(
      paste0("
      <h2> megaplots Package Manual (", packageVersion("megaplots"),")</h2>
      
      <h5> Madhurima Majumder, Susanne Lippert, Bastian Becker,
      ...
      <h3> February 7th, 2024 </h3>
        ...
        <li> You can save a megaplot with all the settings, via Save Session 
