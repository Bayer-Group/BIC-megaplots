...
The variable "Identifier" is used as subject identifier and can be a numeric or 
character variable. 
The variables "start_time" & "end_time" define the start and end time of a subject
