test_that("Check if filtering megaplot data via function 'filter_megaplot_data' works", {
  ...
  testthat::expect_equal(
    result$megaplots_selected_event,
    c("Event 1", "Event 1", "Event 2", "Event 1", "Event 2", NA)
  )
})
