test_that("Check if renaming via function 'rename_require_variables' works", {
  ...
  expect_equal(
    test_data_megaplot$IDENTIFIER,
    result$megaplots_selected_subjectid
  )
  ...
  expect_equal(
    test_data_megaplot$EVENT_GROUP,
    result$megaplots_selected_event_group
  )
  expect_equal(
    test_data_megaplot$EVENT_TIME_START,
    result$megaplots_selected_event_time
  )
  expect_equal(
    test_data_megaplot$EVENT_TIME_END,
    result$megaplots_selected_event_time_end
  )
  ...
  expect_equal(is.data.frame(result), TRUE)
  expect_equal(
    test_data_megaplot$IDENTIFIER_2,
    result$megaplots_selected_subjectid
  )
  expect_equal(test_data_megaplot$START_N, result$megaplots_selected_start_time)
  expect_equal(test_data_megaplot$END_N, result$megaplots_selected_end_time)
